...
import os
import difflib
system_apps=pd.read_csv('C:\Users\Sanath\Documents\Extensions_CSV.csv')
...
installed_apps_dataframe.to_csv('C:\Users\Sanath\Documents\Installed_Apps.csv')

all_applications=pd.concat([system_apps,installed_apps_dataframe])
#all_applications.to_excel("C:\Users\Sanath\Documents\applications.xlsx")

def launch_application(application):
    path="C:\Users\Sanath\Documents"
